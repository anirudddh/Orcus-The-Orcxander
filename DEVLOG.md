# Orcus : The Orcxander !!!
- Orcus tries to defend himself from the local villagers
- Make magic feel like magic
  - Glyphs, cooldowns, screenshake
- Villager just runs at Orcus
- Brute walks, takes more hits
- Archer walks then shoots and repeats
- Priest buries corpses before Orcus can resurrect them
...
- Glyphs circling around Orcus when ready to cast
...
Missing mechanics:
- Villagers attacking Orcus and lose state.
...
Restart mechanics. "Orcus did what any self respecting necromancer would do. He brought himself back..."
...
"Orcus wasn't particularly popular in the town, and that was _before_ he became a necromancer."
...
- Stone mechanics
  - How are stones created?
    ...
    - Throwables?
  - Bloodstones that heal Orcus when destroyed?
- Curses
