...
const INTRO_DIALOGUE = [
  "Orcus wasn't a particularly popular Orcxander...",
  "         The other villagers hunted him.",
  "     Sometimes they even finished the job (@)",
  "  But like any self-respecting Orcxander...",
  "        Orcus just brought himself back.",
];

const OUTRO_DIALOGUE = [
  "",
  "It was over.",
  "Orcus was able to study peacefully.",
...
onpointerup = () => {
  if (game.state === INTRO) {
    play();
    game.state = PLAYING;
    game.player.sprite = sprites.Orcus_arms_down;
  }
